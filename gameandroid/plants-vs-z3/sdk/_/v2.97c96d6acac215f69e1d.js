...
(() => {
    ...
    var e = {
            ...
            421: (e, t, r) => {
                ...
                class i {
                    constructor() {
                        a(this, "promises", {}), a(this, "listeners", {}), a(this, "callbacks", {}), this.addEventListener()
                    }
                ...
                const d = class e extends i {
                    constructor() {
                        if (e.instance) return e.instance;
                        super(), e.instance = this
                    }
                    get _parentTarget() {
                ...
                })(d, "symbol" != typeof(u = "instance") ? u + "" : u, undefined);
                const h = new d
            },
            417: (e, t, r) => {
                r.d(t, {
    ...
    (() => {
        ...
        function s(e, t) {
            ...
            return function(...a) {
                const o = a;
                return r || (r = !0, setTimeout(() => {
                    r = !1
                }, t), n = e.apply(this, o)), n
            }
        }
        var i = r(339),
            c = r(767),
        ...
        const g = class {
            constructor() {
                m(this, "promise"), m(this, "resolve", () => {}), m(this, "reject", () => {}), m(this, "promiseState", 0), this.promise = new Promise((e, t) => {
                    this.resolve = t => {
        ...
        var y = r(715);
        const f = h("sdkTimeout");

        function v(e, t = function() {
            var e;
            ...
            return () => {
                f("resolve", e), r.resolve(), clearTimeout(n)
            }
        }
        ...
        class P {
            constructor(e) {
                ...
                }), w(this, "notifyObservers", (e, t) => e.forEach(e => {
        ...
        const T = {
            ...
            A = class {
                constructor() {
                    S(this, "log", h("Achievements | Child frame", "Dev", T)), S(this, "observable", new P(this.log)), S(this, "setProgress", (e, t) => O(this, null, function*() {
                        return this.post(i.jG.SetProgress({
                            id: e,
                            progress: t
                        }))
                    })), S(this, "getProgress", e => O(this, null, function*() {
                        return this.post(i.jG.GetProgress({
                            id: e
                        }))
                    })), S(this, "getList", (...e) => O(this, [...e], function*(e = ["allLocal"]) {
                        ...
                        action: e,
                        id: t = ""
                    }, r) => this.observable.subscribe(this.buildId(e, t), r)), S(this, "off", ({
                        action: e,
                        id: t
                    }, r) => this.observable.unsubscribe(this.buildId(e, t), r)), S(this, "post", e => O(this, null, function*() {
                        this.log("post to parent", e.action, e.data);
                        const t = v(`AchvManager.${e.action}`);
        ...
        let k = A;
        var C = (e => (e.ADV_IS_NOT_CONNECTED = "ADV_IS_NOT_CONNECTED", e.UNKNOWN = "UNKNOWN", e))(C || {});
        const I = h("NoAds", "Adv"),
        ...
        class G {
            constructor(e) {
                var t;
                F(this, "callbacks", {}), F(this, "adv"), F(this, "onAdvDebugManagerExternalMessage", e => {
                    const {
                        action: t
                    } = e.data;
                    switch (t) {
                ...
                }), F(this, "onAdvManagerExternalMessage", e => {
                    var t, r, n, a, o, s, i, c, l, d, u, h, p;
                    const {
                        action: m,
                        data: g
                    } = e.data;
                    switch (N(`onAdvManagerExternalMessage ${m}`), m) {
                        case "adv-callback-open":
                            null == (r = (t = this.callbacks).onOpen) || r.call(t);
                            break;
                        case "adv-callback-close":
                            this.callOnAdvClose(g.wasShown);
                            break;
                        case "adv-callback-error":
                            this.callOnAdvClose(!1);
                            try {
                                if ("string" != typeof(null == (n = null == g ? void 0 : g.error) ? void 0 : n.message)) {
                                    const e = new Error("Undefined error message");
                                    try {
                                        e.additional = JSON.stringify(g)
                                    } catch (t) {
                                        e.additional = "undefined"
                                    }(0, y.f)(e)
                                }
                            } catch (e) {}
                            null == (o = (a = this.callbacks).onError) || o.call(a, new Error(g.error.message, {
                                cause: g.error
                            }));
                            break;
                        ...
                        case "rewarded-video-callback-error":
                            null == (p = (h = this.callbacks).onError) || p.call(h, new Error(g.error.message, {
                                cause: g.error
                            }));
                            break;
                        case "set-disabled-state":
                            N('On "set-disabled-state" event', e.data, g.value), this.setDisabledState(g.value)
                    }
            ...
            checkDeprecatedOnAdvCloseUsage() {
                "onAdvClose" in this.adv && (0, y.T)(new Error('Deprecated usage "onAdvClose". Please, use `ysdk.adv.method({callbacks})` https://yandex.ru/dev/games/doc/sdk/sdk-adv'))
            }
            showFullscreenAdvDebug(e) {
                this.showFullscreenAdv({
                    callbacks: {
                        onClose: t => N(`${e} onClose, wasShown = ${t}`),
                        onError: t => N(`${e} onError, error =`, t),
                        onOpen: () => N(`${e} onOpen`)
                    }
                })
            }
            ...
            switchStickyBannersDebug(e) {
                this.getBannerAdvStatus().then(({
                    ...
                    t ? this.hideBannerAdv().then(({
                        ...
                        N(`${e} hideBannerAdv, stickyAdvIsShowing = ${t}`)
                    }) : this.showBannerAdv().then(({
                        reason: t,
                        stickyAdvIsShowing: r
                    }) => {
                        N(`${e} hideBannerAdv, stickyAdvIsShowing = ${r}, reason = ${t}`)
                    })
                })
            }
            updateDisabledState() {
            ...
            setDisabledState(e) {
                N("setDisabledState", e), e ? x || (x = !0, I("_disableAds"), function() {
                    var e;
                    ...
                    "function" == typeof(null == (r = null == (t = null == (e = window.Ya) ? void 0 : e.Context) ? void 0 : t.AdvManager) ? void 0 : r.render) && (window.Ya.Context.AdvManager.render = n.render), _();
                    let a = window.Ya;
                    Object.defineProperty(window, "Ya", {
                        get() {
                            var e;
                            return (null == (e = null == a ? void 0 : a.Context) ? void 0 : e.AdvManager) && a.Context.AdvManager !== n && (a.Context.AdvManager = n), _(), a
                        },
                        set(e) {
                            var t;
                        ...
                        AdvManager: n
                    }, window.Ya.Context.AdvManager = n, I("disable Ya.Context.AdvManager.render")
                }()) : x && (x = !1)
            }
            ensureCallbacksIsValid(e, t) {
                ...
                try {
                    ...
                    (0, y.T)(new Error('Error in "ensureCallbacksIsValid"'), {
                        additional: {
            ...
            showFullscreenAdv({
                ...
                const t = v("AdvManager.showFullscreenAdv");
                l.F.postToParent(i.X$.AdvShowFullscreen()).then(({
                    ...
                    (0, y.T)(t, {
                        level: r
                    }), R(e, "onError")(t), R(e, "onClose")(!1), this.callDeprecatedOnClose(!1)
                }).finally(() => {
                    t()
                })
            }
            showRewardedVideo({
                ...
                const t = v("AdvManager.showRewardedVideo");
                l.F.postToParent(i.X$.AdvShowRewardedVideo()).then(({
                    ...
                    (0, y.f)(t), R(e, "onError")(t), R(e, "onClose")(!1)
                }).finally(() => {
                    t()
                })
            }
            showBannerAdv() {
                return new Promise(e => {
                    const t = v("AdvManager.showBannerAdv");
            ...
            hideBannerAdv() {
                return new Promise(e => {
                    const t = v("AdvManager.hideBannerAdv");
            ...
            getBannerAdvStatus() {
                return new Promise(e => {
                    const t = v("AdvManager.getBannerAdvStatus");
        ...
        let W = () => (window.YandexGamesSDKEnvironment || (0, y.f)(new Error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined")), W = () => window.YandexGamesSDKEnvironment || K, W());
        const H = {
                get app() {
                    return W().app
                },
                ...
                get payload() {
                    return W().params.payload
                },
                get isTelegram() {
                    return W().isTelegram
                },
                get domain() {
                    return W().serviceName || W().serviceHostname
                }
            },
            q = r(707).Z;
        var X = Object.defineProperty;
        const z = {
                small: V.f9.ISLANDS_RETINA_SMALL,
                medium: V.f9.ISLANDS_RETINA_MEDIUM,
                large: V.f9.ISLANDS_200
            },
            J = {
                small: V.f9.ISLANDS_200,
                medium: V.f9.ISLANDS_200,
                large: V.f9.BIG
            },
            Q = {
                sdkBackendURL: "",
        ...
        class ee {
            ...
            getMode() {
                var e;
                return (0, y.T)(new Error("Player.getMode() is deprecated. Please, use Player.isAuthorized().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player#auth")), q.sendOnceDeprecatedUsage("Player.getMode"), null != (e = this._personalInfo.mode) ? e : ""
            }
            getPayingStatus() {
                return l.F.postToParent(i.yH.GetGamePurchaseEnabled()).then(({
                    ...
                    e || (0, y.T)(new Error("We provide data on the player's ability to pay in games that already support purchases"), {
                        level: "warn"
                    })
            ...
            getPhoto(e = "medium") {
                ...
                return this._personalInfo.avatarIdHash ? `${Q.sdkBackendURL}/player/avatar/${this._personalInfo.avatarIdHash}/${t}` : `${Z}${V._h}/${t}`
            }
            isAuthorized() {
        ...
        class ae {
            constructor(e) {
                this._playerId = e, ne(this, "_dataHash", null), ne(this, "_timestamp", 0)
            }
            ...
            static byteLength(e) {
                try {
                    ...
                    return ae.byteLengthFallback(e)
                }
            }
            static stringifyData(e) {
                try {
                    ...
                    return (0, y.f)(e), `${Date.now()}.${Math.random()}`
                }
            }
            isSamePlayer(e) {
            ...
            set dataHash(e) {
                this._dataHash = e ? ae.stringifyData(e) : null
            }
            set timestamp(e) {
                this._timestamp = e
            }
            validate(e) {
                const t = ae.stringifyData(e);
                return ae.byteLength(t) > 204800 ? {
        ...
        var oe = Object.defineProperty,
            ...
            de = (e, t) => {
                for (var r in t || (t = {})) ie.call(t, r) && le(e, r, t[r]);
                if (se)
                    for (var r of se(t)) ce.call(t, r) && le(e, r, t[r]);
                return e
            };
        const ue = (e, t) => {
                ...
                if ("signature" in e) {
                    ...
                    if ("string" == typeof r) {
                        const {
                            ...
                            for (var t, r, n = e.replace(/[^A-Za-z0-9\+\/]/g, ""), a = n.length, o = 3 * a + 1 >>> 2, s = new Uint8Array(o), i = 0, c = 0, l = 0; l < a; l++)
                                if (r = 3 & l, i |= U(n.charCodeAt(l)) << 18 - 6 * r, 3 === r || a - l === 1) {
                                    for (t = 0; t < 3 && c < o; t++, c++) s[c] = i >>> (16 >>> t & 24) & 255;
                                    i = 0
                                } return s
                        }(r.split(".")[1])));
                        return {
        ...
        l.F.onExternalMessage("auth", e => {
            if ("changed" === e.data.action && Ee) {
                ge("Call onLogoutCallback()");
                try {
                    Ee()
                } catch (e) {
                    console.error()
        ...
        class Se extends ee {
            constructor(e, t) {
                super(e), me(this, "data"), me(this, "dataPromise", null), me(this, "statsPromise"), me(this, "config"), me(this, "getApiPromise", () => new Promise((e, t) => {
                    this.getPlayerData().then(t => {
                        this.data = t, e(t)
                    }).catch(e => {
                        this.dataPromise = null, t(e)
                    })
                })), me(this, "getPlayerData", () => {
                    ...
                    var e, t
                }), me(this, "getDataPromise", () => void 0 !== this.data ? Promise.resolve(this.data) : H.isTelegram ? (ue("getData", {
                    key: he
                }), new Promise((e, t) => {
                    function r(n) {
                        var a;
                ...
                })).catch(() => this.getPlayerData()) : this.getApiPromise()), this.config = t, Pe && Pe.isSamePlayer(this.getUniqueID()) || (Pe = new ae(this.getUniqueID()))
            }
            onLogout(e) {
                ge("Set onLogout callback"), Ee = e
            }
            getIDsPerGame() {
            ...
            getData(e) {
                return this.dataPromise = this.getDataPromise(), this.dataPromise.then(t => ve(t, e))
            }
            setData(e, t = !1) {
                var r;
                if (H.isTelegram && (r = e, ue("setData", {
                        key: he,
                ...
                const n = function(e, t = !1) {
                    const r = Pe.validate(e);
                    return r.error ? r.reject ? Promise.reject(r.error) : ((0, y.T)(r.error), Promise.resolve(!0)) : new Promise((r, n) => {
                        we && window.clearTimeout(we);
                        let a = t ? 200 : Math.max(200, Pe.getWaitTime());
                        Pe.timestamp = Date.now(), we = window.setTimeout(() => {
                            l.F.postToParent(i.Uh.SetData({
                                data: e
                            })).then(() => {
                                Pe.dataHash = e, r(!0)
                            }).catch(e => {
                                Pe.timestamp = 0, Pe.dataHash = null, n(e)
                            })
                        }, a)
                    })
                }(e, t);
            ...
            getStats(e) {
                return void 0 === this.statsPromise && (this.statsPromise = new Promise((e, t) => {
                    l.F.postToParent(i.Uh.Stats({
                        ...
                        data: e
                    }) => fe(e)).then(e).catch(t).finally(() => this.statsPromise = void 0)
                })), this.statsPromise.then(t => ve(t, e))
            }
            setStats(e) {
                return be(e) ? l.F.postToParent(i.Uh.SetStats({
                    stats: e
                })).then(({
                    data: e
            ...
            incrementStats(e) {
                return be(e) ? l.F.postToParent(i.Uh.IncrementStats({
                    increments: e,
                    signed: this.config.signed
                })).then(({
                    data: e
                }) => fe(e.result)) : Promise.reject(new Error("Increments is not valid"))
            }
        }
        const Oe = new Set;
        let Te = !1;
        const Ae = "function" != typeof Proxy ? e => e : (e, t, r) => Te ? e : new Proxy(e, {
                get: (e, n) => ("symbol" != typeof n && !Te && t.includes(n) && Oe.add(`${r}.${n}`), e[n])
            }),
            ke = () => {
                Te || (l.F.postToParent((0, i.Iq)(Array.from(Oe).join(","))), Oe.clear(), Te = !0)
            },
            Ce = h("PlayerProxy"),
            Ie = new M;
        ...
        function De() {
            return e = this, t = arguments, r = function*(e = {}) {
                var t;
                const r = null == (t = Ie.getFor(e)) ? void 0 : t.promise;
                if (r) return r;
                const n = v("getPlayer", 12e4),
                    a = new g;
                return a.promise.finally(() => {
                    n()
                }), Ie.setFor(e, a), window.setTimeout(() => {
                    Ie.setFor(e, void 0)
                    ...
                    const {
                        ...
                        const n = new Se(t, e);
                        return B(n, r), Ae(n, ["getPayingStatus", "getStats", "getData", "getName"], "Player")
                    }(e, r, n);
                    a.resolve(o)
                }).catch(t => {
                    Ie.setFor(e, void 0), a.reject(t)
                }), a.promise
            }, new Promise((n, a) => {
                var o = e => {
                        try {
        ...
        function _e() {
            Ce("Clear getPlayer promises."), Ie.clear()
        }
        l.F.onExternalMessage("auth", e => {
            ["auth-dialog-cancel", "auth-dialog-success", "changed"].includes(e.data.action) && _e()
        });
        const xe = new class {
            openAuthDialog() {
                const e = v("AuthManagerPublic.openAuthDialog", 12e4),
        ...
        var Fe = Object.defineProperty,
            ...
            Ue = (e, t, r) => t in e ? Fe(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r;
        const Be = s(e => l.F.postToParent(i.S.Score(e)).then(({
            data: e
        }) => e.result), 1e3);
        class Ve {
            constructor() {
                var e;
                Ue(this, "symbol" != typeof(e = "lastTimeLeaderboardWasSend") ? e + "" : e, undefined)
            }
            getLeaderboardDescription(e) {
                const t = v("Leaderboards.getLeaderboardDescription"),
            ...
            getLeaderboardStat(e) {
                const t = v("Leaderboards.getLeaderboardStat"),
            ...
            getLeaderboardEntries(e, t) {
                const {
                    ...
                    quantityAround: n = 5,
                    quantityTop: a = 5
                } = t || {}, o = v("Leaderboards.getLeaderboardEntries"), s = l.F.postToParent(i.S.Entries({
                    include_user: r,
                    name: e,
                    quantity_around: n,
                    quantity_top: a
            ...
            setLeaderboardScore(e, t, r) {
                ...
                return this.lastTimeLeaderboardWasSend && !this.canSetLeaderboardScoreByTime() ? Promise.reject("The request to setLeaderboardScore can be sent no more than once per second") : (r && (n.extraData = r), this.lastTimeLeaderboardWasSend = Date.now(), Be(n))
            }
            ...
            transformLeaderboardEntry(e, t) {
                ...
                return c = ((e, t) => {
                    for (var r in t || (t = {})) $e.call(t, r) && Ue(e, r, t[r]);
                    if (Ge)
                        for (var r of Ge(t)) Me.call(t, r) && Ue(e, r, t[r]);
                    return e
                })({}, e), Ne(c, Re({
                    player: {
                        getAvatarSrc: (e = "medium") => (z[e] || (e = "medium"), `${i}/${z[e]}`),
                        getAvatarSrcSet: (e = "medium") => (z[e] || (e = "medium"), `${i}/${z[e]} 1x, ${i}/${J[e]} 2x`),
                        lang: n,
                        publicName: a,
                        scopePermissions: o,
                        uniqueID: s
        ...
        const Ye = () => {
            (0, y.T)(new Error("ysdk.getLeaderboards() is deprecated. Please, use ysdk.leaderboards.\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-leaderboard")), q.sendOnceDeprecatedUsage("ysdk.getLeaderboards()");
            const e = new Ve;
        ...
        class He extends Error {
            constructor({
                ...
                super(r, n, a), We(this, "code"), We(this, "httpStatus"), this.name = "PaymentsError", this.code = e, this.httpStatus = t, Object.setPrototypeOf(this, He.prototype), Error.captureStackTrace && Error.captureStackTrace(this, He)
            }
            toJSON() {
                return {
                    code: this.code,
        ...
        const qe = He,
            Xe = new Set(["ru", "uk", "be", "kk", "uz"]);
        var ze = (e => (e.BE = "be", e.EN = "en", e.KK = "kk", e.RU = "ru", e.TR = "tr", e.UK = "uk", e.UZ = "uz", e))(ze || {});
        const Je = ze.RU;

        function Qe(e, t = Je, r = "") {
            if (e) {
                if ("string" == typeof e) return e;
                if (t in e) return e[t] || r;
                if (!(e => !e || Xe.has(e))(t) && "en" in e) return e.en || r;
                if (Je in e) return e[Je] || r
            }
            return r
        }
        var Ze, et = Object.defineProperty;
        const tt = Symbol("codePath"),
            rt = Symbol("appId"),
            nt = Symbol("sendMetricaParams"),
            at = Symbol("currencyPriceStat"),
            ot = Symbol("sendOnceCurrencyCodeStat"),
            st = Symbol("getCurrencyImageUrlPrefix"),
            it = Symbol("currencyCodeStat");
        class ct {
            constructor(e) {
                this._productData = e, ((e, t, r) => {
                    ((e, t, r) => {
                        t in e ? et(e, t, {
                            enumerable: !0,
                            configurable: !0,
            ...
            get title() {
                return Qe(this._productData.title)
            }
            get description() {
                return Qe(this._productData.description)
            }
            get imageURI() {
                const {
                    image: e
            ...
            getPriceCurrencyImage(e = "small") {
                if ("svg" === e) return `${this[st]()}/currency-icon-m.svg`;
                let t = "s";
                switch (e) {
                    case "medium":
                    case "small":
                ...
                return `${this[st]()}/currency-icon-${t}${r?"@2x":""}.png`
            }
            toJSON() {
                return {
                    id: this.id,
            ...
            get[it]() {
                ...
                return `//yastatic.net/s3/games-static/static-data/images/payments/sdk${this[tt]}`
            }
            get[at]() {
        ...
        class ut extends ct {
            get priceCurrencyCode() {
                var e;
                return super.priceCurrencyCode, this[at] ? this[at].currency : null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.moneyCodeSymbol
            }
            get price() {
                return `${this.priceValue} ${this.priceCurrencyCode}`
            }
            get priceValue() {
                return this[at] ? String((e => {
                    const t = e / V.Uo;
                    return Math.ceil(100 * t) / 100
                })(this[at].priceValue)) : super.priceValue
            }
            get[tt]() {
                var e, t;
                return this[at] ? `/${this[at].currency.toLowerCase()}` : (null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.moneyCodeSymbol) ? `/${null==(t=window.YandexGamesSDKEnvironment)?void 0:t.moneyCodeSymbol.toLowerCase()}` : ""
            }
            get [rt]() {
                return (0, lt.o)()
            } [nt](e) {
        ...
        class pt {
            constructor(e) {
                ...
                })(this, "purchaseData"), this.purchaseData = e
            }
            get productID() {
        ...
        var mt = Object.defineProperty,
            ...
            Pt = (e, t) => {
                for (var r in t || (t = {})) vt.call(t, r) && wt(e, r, t[r]);
                if (ft)
                    for (var r of ft(t)) bt.call(t, r) && wt(e, r, t[r]);
                return e
            },
            Et = (e, t) => gt(e, yt(t));
        const St = h("Payment");
        class Ot {
            ...
            getCatalog() {
                return new Promise((e, t) => {
                    const r = v("Payments.getCatalog");
                    l.F.postToParent(i.yH.GetCatalog({
                        lang: H.i18n.lang
                    })).then(({
                        data: t
                    }) => {
                        St("get-catalog result", t), e(t.products.map(e => new ut(e)))
                    }).catch(e => {
                        t(e)
                    }).finally(() => {
                        r()
            ...
            purchase(e) {
                ...
                return new Promise((t, r) => {
                    l.F.postToParent(i.yH.PurchaseStart({
                        paymentsConfig: Et(Pt({}, this._config), {
                            lang: H.i18n.lang
                        }),
                        purchaseConfig: e
                    })).then(({
                        ...
                        St("purchase-start catch"), r(e)
                    })
                })
            }
            getPurchases() {
                return new Promise((e, t) => {
                    const r = v("Payments.getPurchases");
                    l.F.postToParent(i.yH.GetPurchases({
                        ...
                        St("getPurchases callback", t);
                        const n = t.map(e => new pt({
                            productID: e.product.id,
                            purchaseToken: e.token,
                            developerPayload: e.developerPayload
                        }));
            ...
            consumePurchase(e) {
                return new Promise((t, r) => {
                    const n = v("Payments.consumePurchase");
                    l.F.postToParent(i.yH.PurchaseConsume({
                        token: e
                    })).then(({
                        data: e
                    }) => {
                        if (console.info("consumePurchase data"), console.info(e), !e || !e.token) throw new qe({
        ...
        const It = Ct || function() {
            ...
            Dt = /iPad|iPhone|iPod/.test(navigator.platform),
            _t = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
            xt = Dt || _t,
            Lt = /app-[^.]+\.games\.s3\.yandex\.net$/.test("192.168.89.39"),
            jt = !Lt && xt,
            Ft = function(e, t) {
                ...
                (0, y.f)(new Error("localStorage is broken on iOS/MacOS - https://developer.apple.com/forums/thread/109909\nPlease use YaGames.init().then(ysdk => ysdk.getStorage()).then(storage => storage.setItem('key', 'value'))"))
            }),
            Nt = class e {
                static setup() {
                    jt && Object.defineProperty(window, "localStorage", {
                        get: function() {
                            return Ft(), It
                        }
                    }), xt && Lt && e.setProxy() && e.backup()
                }
                static load() {
                    if (e.onloadPromise_) return e.onloadPromise_;
                    const t = e.getCustomLocalStorage();
                    return t ? (e.onloadPromise_ = Promise.race([At(5e3).then(() => {
                        ...
                        return t
                    })]).catch(e => (console.error(e), It)), e.onloadPromise_) : Promise.resolve(It)
                }
                static getCustomLocalStorage() {
                    return "function" != typeof Proxy ? null : new Proxy({
                        clear() {
                            It.clear.call(It), l.F.postToParent(i.Qq.Clear())
                        },
                        getItem: e => It.getItem.call(It, e),
                        key: e => It.key.call(It, e),
                        get length() {
                            return It.length
                        },
                        removeItem(e) {
                            It.removeItem.call(It, e), l.F.postToParent(i.Qq.Del(e))
                        },
                        setItem(e, t) {
                            It.setItem.call(It, e, String(t)), l.F.postToParent(i.Qq.Set(e, t))
                        }
                    }, {
                        get: function(e, t) {
        ...
        })(Nt, "symbol" != typeof(Rt = "onloadPromise_") ? Rt + "" : Rt);
        let Gt = Nt;

        function $t() {
            return !xt && Ct ? Promise.resolve(Ct) : Gt.load()
        }
        var Mt = Object.defineProperty,
            ...
            Ht = (e, t) => {
                for (var r in t || (t = {})) Yt.call(t, r) && Wt(e, r, t[r]);
                if (Vt)
                    for (var r of Vt(t)) Kt.call(t, r) && Wt(e, r, t[r]);
                return e
            };
        const qt = e => ({
            get id() {
        ...
        var Xt = Object.defineProperty,
            ...
            rr = (e, t) => {
                for (var r in t || (t = {})) Zt.call(t, r) && tr(e, r, t[r]);
                if (Qt)
                    for (var r of Qt(t)) er.call(t, r) && tr(e, r, t[r]);
                return e
            },
            nr = (e, t) => zt(e, Jt(t)),
            ar = (e, t, r) => (tr(e, "symbol" != typeof t ? t + "" : t, r), r),
            or = (e, t, r) => new Promise((n, a) => {
                var o = e => {
                        try {
                            i(r.next(e))
                        } catch (e) {
        ...
        const sr = () => ({
            ...
            ir = class {
                constructor(e) {
                    ar(this, "signed"), ar(this, "getCatalog", () => or(this, null, function*() {
                        var e;
                        const {
                            data: t
                        } = yield l.F.postToParent(i.Aw.Catalog(sr()));
                        return (null != (e = null == t ? void 0 : t.bonuses) ? e : []).map(qt)
                    })), ar(this, "getPlayerBonuses", () => or(this, null, function*() {
                        const {
                            data: e
                        } = yield l.F.postToParent(i.Aw.PlayerBonuses(nr(rr({}, sr()), {
                            signed: this.signed
                        })));
                        return this.signed ? e : e ? e.map(e => nr(rr({}, qt(e.item)), {
                            receivedAt: e.created,
                            token: e.token
                        })) : []
                    })), ar(this, "consume", e => l.F.postToParent(i.Aw.Consume({
                        params: {
                            token: e
                        },
                        signed: this.signed
        ...
        function ur(e) {
            ...
            if ("DIV" === e.tagName && e.getAttribute("style") && !e.querySelector("div") && !e.classList.length && !e.id) {
                ...
                e && (dr(`popup message = ${e}`), l.F.postToParent((0, i.Bz)({
        ...
        function hr() {
            ...
            if (dr("captureUnityAlert isUnity", e), e && (document.querySelectorAll("div[style]:not([id]):not([class])").forEach(ur), "undefined" != typeof MutationObserver)) {
                const e = new MutationObserver(e => {
                    e.forEach(e => {
                        "childList" === e.type && setTimeout(() => {
                            Array.from(e.addedNodes).forEach(ur)
                        }, 0)
                    })
                });
        ...
        const pr = new class {
            writeText(e) {
                ...
                return new Promise((t, r) => {
                    const n = v("ClipboardPublic.writeText");
        ...
        var gr = r(897),
            ...
            Pr = (e, t) => {
                ...
                if (fr)
                    for (var r of fr(t)) br.call(t, r) && wr(e, r, t[r]);
                return e
            };
        ...
        var Or = Object.defineProperty,
            ...
            Ir = (e, t) => {
                for (var r in t || (t = {})) Ar.call(t, r) && Cr(e, r, t[r]);
                if (Tr)
                    for (var r of Tr(t)) kr.call(t, r) && Cr(e, r, t[r]);
                return e
            };
        ...
        function _r(e) {
            return {
                ...
                error: e,
                source: "game",
                sourceMethod: (0, gr.Z)(e.stack)
            }
        }
        const xr = new class {
            constructor(e, t) {
                this.source = e, this.additionalErrorData = t, ((e, t) => {
                    Cr(this, t + "", void 0)
                })(0, "logger"), this.source = e, window.addEventListener("error", this), "Promise" in window && window.addEventListener("unhandledrejection", this)
            }
            addLogger(e) {
                this.logger = e
            }
            ...
            _unsafeHandlePromiseRejectionEvent(e) {
                ...
                console.error(o.message, V.X4, o), this._postError(o, "unhandled")
            }
            _unsafeHandleErrorEvent(e, t) {
                ...
                (this.additionalErrorData || (null == i ? void 0 : i.additional)) && (c.additional = Ir(Ir({}, null == i ? void 0 : i.additional), this.additionalErrorData)), console.error(c.message, V.X4, c), this._postError(c, t)
            }
            _trimErrorData(e, t) {
            ...
            function() {
                try {
                    ...
                    console.error = (...t) => {
                        ...
                        try {
                            "string" == typeof t[1] && t[1] === V.X4 ? t.splice(1, 1) : Dr(_r(r), "console.error")
                        } catch (e) {}
                        e.apply(console, t)
                    }
                } catch (e) {
        ...
        var Lr = Object.defineProperty,
            ...
            $r = (e, t, r) => t in e ? Lr(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r;
        const Mr = h("Events bus", "Dev", {
                background: "#0072B5",
                text: "#ffffff"
            }),
            Ur = new P(Mr),
            Br = [c.US, c.Tn, c.Ul],
            Vr = e => l.F.postToParent(i._W.ListenersChange({
                event: e,
                count: Ur.getObserversNumber(e)
            })),
            Yr = {
                EXIT: Vr,
                HISTORY_BACK: Vr,
                ACCOUNT_SELECTION_DIALOG_OPENED: Vr,
                ACCOUNT_SELECTION_DIALOG_CLOSED: Vr
            },
            Kr = (Wr = ((e, t) => {
        ...
        const qr = (e, t) => {
                var r;
                Mr(`[on]: {${e}}`);
                const n = Ur.subscribe(e, t);
                return null == (r = Kr[e]) || r.call(Kr, e, t), () => {
                    var r;
                    n(), null == (r = Yr[e]) || r.call(Yr, e, t)
                }
            },
            Xr = (e, t) => {
                var r;
                Mr(`[off]: {${e}}`), Ur.unsubscribe(e, t), null == (r = Yr[e]) || r.call(Yr, e, t)
            },
            zr = (e, t) => {
                Mr(`[notifyObservers]: {${e}}`, ...t ? [t] : []), Ur.notifyObservers(Array.isArray(e) ? e : [e], t)
            };
        l.F.onExternalMessage(Br, ({
            data: {
                action: e,
                data: t
            }
        }) => zr(e, t));
        const Jr = h("Gameplay | Child frame", "Dev", {
                background: "#6c5b7b",
                text: "#ffffff"
            }),
            Qr = e => {
                Jr(`[POST]: {${e}}`), l.F.postToParent((0, i.$J)(e))
            };
        var Zr, en = Object.defineProperty,
            tn = (e, t, r) => (((e, t, r) => {
                t in e ? en(e, t, {
                    enumerable: !0,
                    configurable: !0,
        ...
        const rn = Symbol("promises"),
            nn = class e {
                constructor() {
                    if (tn(this, Zr, new Map), e.instance) return e.instance
                }
                getAllGames() {
                    const e = this[rn].get("all");
                    if (e) return e;
                    const t = v("getAllGames"),
                        r = new Promise((e, r) => l.F.postToParent(i.Rh.All({
                            lang: H.i18n.lang
                        })).then(({
                            data: t
                        }) => e(t)).catch(e => {
                            this[rn].delete("all"), r(e)
                        }).finally(() => t()));
                    return this[rn].set("all", r), r
                }
                getGameByID(e) {
                    const t = this[rn].get(`${e}`);
                    if (t) return t;
                    const r = v("getGameByID"),
                        n = new Promise((t, n) => l.F.postToParent(i.Rh.Game({
                            ...
                            this[rn].delete(`${e}`), n(t)
                        }).finally(() => r()));
                    return this[rn].set(`${e}`, n), n
                }
            };
        Zr = rn, tn(nn, "instance");
        let an = nn;
        an.instance = Ae(new an, ["getGameByID", "getAllGames"], "GamesAPI");
        const on = an.instance;
        ...
        const ln = class e {
            constructor() {
                cn(this, "isReady", !1), cn(this, "startTimestamp", Date.now()), cn(this, "readyFallbackTimerId"), this.startReadyFallbackTimeout()
            }
            ready() {
        ...
        cn(ln, "MAX_TIMEOUT", 3e4);
        let dn = ln;
        var un, hn, pn, mn, gn = Object.defineProperty,
        ...
        class bn {
            constructor(e = {}) {
                fn(this, un), fn(this, hn), fn(this, pn), fn(this, mn, on);
                for (let t in c.VR) c.VR[t] in e && e[c.VR[t]] && (this[t] = new vn[t]);
                for (let t of c.Hn) !this[t] && (t in e && e[t] || !(t in e)) && (this[t] = new vn[t]);
                l.F.postToParent((0, i.OI)(c.ur.GameInit))
            }
        }
        un = c.VR.GameplayAPI, hn = c.VR.LoadingAPI, pn = c.VR.PluginEngineDataReporterAPI, mn = c.VR.GamesAPI;
        var wn = (e => (e.GAME_RATED = "GAME_RATED", e.NO_AUTH = "NO_AUTH", e.REVIEW_ALREADY_REQUESTED = "REVIEW_ALREADY_REQUESTED", e.REVIEW_WAS_REQUESTED = "REVIEW_WAS_REQUESTED", e.UNKNOWN = "UNKNOWN", e))(wn || {});
        const Pn = new class {
            canReview() {
                return new Promise(e => {
                    const t = v("Feedback.canReview");
            ...
            requestReview() {
                return new Promise(e => {
                    const t = v("Feedback.requestReview", 12e4);
        ...
        function Tn() {
            const e = [],
                t = {
                    ...
                    webgl: En(document.createElement("canvas")),
                    webgl2: Sn(document.createElement("canvas"))
                };
        ...
        var An, kn = r(308),
            Cn = ((An = Cn || {}).Finish = `${c.vA}-sessions-finish`, An.Transaction = `${c.vA}-sessions-transaction`, An),
            ...
            Ln = (e, t, r) => t in e ? In(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r,
            jn = (e, t, r) => new Promise((n, a) => {
                var o = e => {
                        try {
                            i(r.next(e))
                        } catch (e) {
        ...
        const Fn = h("Multiplayer Sessions | Child frame", "Dev", {
                background: "#b55a30",
                text: "#ffffff"
            }),
            Nn = ({
                ...
                "transaction" === e ? zr(Cn.Transaction, t) : "finish" === e && zr(Cn.Finish, t)
            };
        class Rn {
            constructor() {
                l.F.onExternalMessage(c.vA, Nn)
            }
            commit(e) {
                l.F.postToParent(kn.T.Commit(e))
            }
            init() {
                return jn(this, arguments, function*(e = {}) {
                    const t = ((e, t) => {
                        for (var r in t || (t = {})) _n.call(t, r) && Ln(e, r, t[r]);
                        if (Dn)
                            for (var r of Dn(t)) xn.call(t, r) && Ln(e, r, t[r]);
                        return e
                    })({
                        isEventBased: !0
                    }, e);
                    return Fn("[init]", t), t.meta && 0 === t.count || Fn("[init] NOTE: multiplayer was initialized for recording only: {meta} or {count} parameters were not provided."), (yield l.F.postToParent(kn.T.Init(t))).data
                })
            }
            push(e) {
                return jn(this, null, function*() {
                    return l.F.postToParent(kn.T.Push(e))
                })
            }
        }
        const Gn = {
        ...
        function $n(...e) {
            ...
            return e.reduce((e, r) => (Object.keys(r).forEach(n => {
                const a = e[n],
                    o = r[n];
                Array.isArray(a) && Array.isArray(o) ? e[n] = a.concat(...o) : t(a) && t(o) ? e[n] = $n(a, o) : e[n] = o
            }), e), {})
        }
        ...
        function Mn(e, t = {}) {
            ...
            return (null == (n = null == (r = window.YandexGamesSDKEnvironment) ? void 0 : r.request.experiments) ? void 0 : n.signed) && (t.signed = !0),
                function(e) {
                    ...
                    "signed" !== e && (0, y.f)(new Error(`Using deprecated key in YaGames.init options: ${e}`))
                }),
                function(e = {}) {
                    return function(e) {
                        "adv" in e && q.sendOnceDeprecatedUsage("SDK init options with adv"), e.adv = e.adv || {},
                            function(e) {
        ...
        const Kn = class {
            constructor(e) {
                Vn(this, "payments", null), Vn(this, "initPromise", null), Vn(this, "signed"), Vn(this, "getCatalog", () => Yn(this, null, function*() {
                    return (yield this.ensureInitialized()).getCatalog()
                })), Vn(this, "purchase", e => Yn(this, null, function*() {
                    return (yield this.ensureInitialized()).purchase(e)
                })), Vn(this, "getPurchases", () => Yn(this, null, function*() {
                    return (yield this.ensureInitialized()).getPurchases()
                })), Vn(this, "consumePurchase", e => Yn(this, null, function*() {
                    return (yield this.ensureInitialized()).consumePurchase(e)
                })), this.signed = Boolean(e)
            }
            ensureInitialized() {
                return Yn(this, null, function*() {
                    return this.payments ? this.payments : (this.initPromise || (this.initPromise = Tt({
                        signed: this.signed
        ...
        const Xn = (() => {
            ...
            try {
                const t = new e("test");
                return document.dispatchEvent(t), e
            } catch (e) {}
            try {
                const e = document.createElement("iframe");
                e.style.display = "none", e.style.position = "absolute", e.style.width = "0", e.style.height = "0", e.style.border = "none", document.body.appendChild(e);
                const t = e.contentWindow,
                    r = t && t.Event;
                if (document.body.removeChild(e), r) {
                    const e = new r("test");
                    return document.dispatchEvent(e), r
                }
            } catch (e) {}
            return e
        })();
        class zn {
            constructor() {
                qn(this, "_status"), qn(this, "onMessage", e => {
                    const {
                        action: t
                    } = e.data;
                    if ("fullscreenchange" === t) {
                        try {
                            document.dispatchEvent(new Xn("fullscreenchange"))
                        } catch (e) {
                            (0, y.f)(new Error("Failed to dispatch fullscreenchange event: " + e))
                        }
            ...
            request() {
                const e = v("FullscreenManager.request"),
            ...
            exit() {
                const e = v("FullscreenManager.exit"),
            ...
            toggle() {
                const e = v("FullscreenManager.toggle"),
        ...
        class Jn {
            constructor() {
                qn(this, "fullscreen"), this.fullscreen = new zn
            }
        }
        var Qn = r(382);
        const Zn = Date.now(),
            ea = `id_cursorHighlighter_${Zn}`,
            ta = `cursorHighlighter_${Zn}`,
            ra = `active_${Zn}`,
            na = {
                [c.q1.EXIT]: !0
            },
            aa = ["passport.ya", "passport.yandex", "an.yandex.ru", "avatars.mds.yandex.net", "/api/"];

        function oa(e) {
            const t = Cache.prototype[e];
            Cache.prototype[e] = function(e, r) {
                return "GET" !== e.method || 0 !== e.url.indexOf("https://") || (n = e.url, aa.some(e => -1 !== n.indexOf(e))) ? Promise.resolve() : ("ignoreSearch" in (r = r || {}) || (r.ignoreSearch = !0), t.call(this, e, r));
                var n
            }
        }
        const sa = class {
                static overrideCacheSearch() {
                    ("function" != typeof Cache ? (console.warn("Can not find `Cache` function"), 0) : "function" != typeof Cache.prototype.match ? (console.warn("Can not find `Cache.match` function"), 0) : "function" == typeof Cache.prototype.matchAll || (console.warn("Can not find `Cache.matchAll` function"), 0)) && (oa("match"), oa("matchAll"))
                }
            },
            ia = new class {
                canShowPrompt() {
                    return new Promise(e => {
                        const t = v("Shortcut.canShowPrompt");
                ...
                showPrompt() {
                    return new Promise(e => {
                        const t = v("Shortcut.showPrompt", 12e4);
        ...
        function da(e = {}) {
            ...
            const a = v("get_flags/fetch"),
                o = new g;
            return o.promise.finally(() => {
                a()
            }), la.setFor(e, o), l.F.postToParent(i.XT.Fetch({
                clientFeatures: t
            })).then(({
                data: e
            }) => {
                ...
                o.resolve(r), la.setFor(e, void 0)
            }), o.promise
        }
        class ua {
            reachGoal(e, t, r) {
            ...
            pa = e => {
                ...
                "function" == typeof n && (window.ym.a.push = function(...t) {
                    ...
                    if (e.metrikaCounter && "reachGoal" === o && s) {
                        ...
                        ha.reachGoal(e.metrikaCounter, t, r)
                    }
        ...
        const fa = class {
            constructor() {
                ga(this, "leaderboards"), ga(this, "getDescription", e => ya(this, null, function*() {
                    return this.leaderboards.getLeaderboardDescription(e)
                })), ga(this, "getEntries", (e, t) => ya(this, null, function*() {
                    return this.leaderboards.getLeaderboardEntries(e, t)
                })), ga(this, "getPlayerEntry", e => ya(this, null, function*() {
                    return this.leaderboards.getLeaderboardPlayerEntry(e)
                })), ga(this, "setScore", (e, t, r) => ya(this, null, function*() {
                    return this.leaderboards.setLeaderboardScore(e, t, r)
                })), this.leaderboards = new Ve
            }
        };
        ga(fa, "init", () => {
            const {
        ...
        ! function() {
            var e;
            if (lr()) dr("alert hook disabled");
            else try {
                "function" == typeof window.alert && (e = window.alert, window.alert = function() {
                    const t = arguments[0];
                    return dr(`alert message = ${t}`), l.F.postToParent((0, i.Bz)({
        ...
        const Sa = Pa(void 0, null, function*() {
            return function({
                staticOrigin: r,
                version: n,
                logError: s
            ...
            (() => {
                ...
                a = /games\.s3\.yandex\.net$/.test(t) ? `https://yandex.ru/games/app/${n}${r}${e}` : `https://yandex.com/games/app/${n}${r}${e}`, window.top.location.replace(a)
                    ...
                    url: location.href,
                    draftDetectedInIframe: lr()
                })), window.loadEnvironmentPromise = window.loadEnvironmentPromise || new Promise((e, t) => {
                    const r = v("loadEnvironment");
                    l.F.postToParent((0, i.VT)()).then(({
                        data: t
                    }) => {
                        Q.sdkBackendURL = String(t.enviroment.sdkBackendURL), Object.freeze(Q), delete t.enviroment.sdkBackendURL, e(t)
                    }).catch(e => {
                        t(e)
                    }).finally(() => {
                        r()
                    ...
                    const t = !("enviroment" in e && "options" in e),
                        r = t ? e : e.enviroment;
                    return window.YandexGamesSDKEnvironment = r, pa(r), Ea("APP_VERSION", r.APP_VERSION), !t && e.options
                }),
                function() {
        ...
        class Aa {
            constructor(e) {
                var t, r;
                wa(this, "achievements"), wa(this, "adv"), wa(this, "analytics"), wa(this, "auth"), wa(this, "bonuses"), wa(this, "clipboard"), wa(this, "deviceInfo"), wa(this, "environment"), wa(this, "features"), wa(this, "feedback"), wa(this, "isAvailableMethod"), wa(this, "getLeaderboards"), wa(this, "getPayments"), wa(this, "getPlayer"), wa(this, "getStorage"), wa(this, "getFlags"), wa(this, "leaderboards"), wa(this, "multiplayer"), wa(this, "notifications"), wa(this, "payments"), wa(this, "screen"), wa(this, "serverTime"), wa(this, "shortcut"), wa(this, "yandexApp"), wa(this, "EVENTS"), wa(this, "dispatchEvent"), wa(this, "onEvent"), wa(this, "dispatch"), wa(this, "on"), wa(this, "off"), e = Mn(e), this.EVENTS = {
                    ...
                    const r = v("getSdkEventsDispatcher");
                ...
                }, this.onEvent = (e, t) => (console.warn("Deprecated usage of `ysdk.onEvent`, please use `ysdk.on(...)` instead."), qr(e, t)), this.achievements = k.init(), this.adv = Ae(new G(e), ["showBannerAdv"], "AdvManager"), this.analytics = {
                    yaMetrikaCounter: Ae(new ua, ["hit", "reachGoal"], "YaMetrikaCounter")
                }, this.auth = xe, this.bonuses = cr.init(e.signed), this.clipboard = pr, this.deviceInfo = new mr(e.deviceType), Ca.deviceInfo = this.deviceInfo, this.environment = (e => {
                    ...
                    return Object.defineProperty(t, "i18n", {
                        get() {
                            const t = e.i18n;
                            return new Proxy(t, {
                                get: (e, t) => ("lang" === t && l.F.postToParent(te.i.I18n()), e[t])
                            })
                        }
                    }), t
                })(H), this.feedback = Pn, this.isAvailableMethod = (r = this, e => {
                    const t = v("isAvailableMethod"),
                        n = l.F.postToParent(i.sC.CheckAvailability({
                            ...
                            const a = {
                                    ...
                                    payments: Ot,
                                    player: Se,
                                    storage: Gt.getCustomLocalStorage()
                                },
                                o = e.split(".");
                            let s = (i = Ht(Ht({}, a), r), c = {
                                leaderboards: Ht({
                                    getLeaderboardDescription: Ve.prototype.getLeaderboardDescription,
                                    getLeaderboardEntries: Ve.prototype.getLeaderboardEntries,
                                    getLeaderboardPlayerEntry: Ve.prototype.getLeaderboardPlayerEntry,
                                    setLeaderboardScore: Ve.prototype.setLeaderboardScore
                                }, r.leaderboards)
                            }, Ut(i, Bt(c)));
                            var i, c;
                            for (let e = 0; e < o.length; e++) {
                                const t = s[o[e]];
                                if (!t) return !1;
                                if (e === o.length - 1) return Le(t);
                                if (!je(t)) return !1;
                                s = je(t.prototype) ? t.prototype : t
                            }
                            return !1
                        });
                    return n.finally(() => {
                ...
                }), this.shortcut = ia, this.getPlayer = De, this.getStorage = $t, this.multiplayer = (() => {
                    const e = new Rn;
                    return {
                        get sessions() {
                            return e
                ...
                })(), this.notifications = Gn, this.getLeaderboards = Ye, this.leaderboards = va.init(), this.getPayments = Un, this.payments = Wn.init(e.signed), this.screen = new Jn, this.features = Ae(new bn(e.features), [c.VR.GameplayAPI, c.VR.LoadingAPI], "FeatureManager"), this.yandexApp = {
                ...
                }(), this.getFlags = da, this.dispatch = zr, this.on = qr, this.off = Xr
            }
        }
        ...
        try {
            Ta = new URLSearchParams(location.hash.slice(1)).get("device-type")
        } catch (e) {}
        class Ca {
            constructor() {
            ...
            static init(e) {
                return Pa(this, null, function*() {
                    let t = location.hash;
                    try {
                        const e = yield Pa(void 0, null, function*() {
                            let e;
                            try {
                                e = yield(t = function*() {
                                    return new Promise((e, t) => {
                    ...
                    return Oa ? (console.warn("YaGames was initialized"), Oa) : (this.longtaskObserver(), Ea("Start initialization"), yield Sa, Oa = new Promise((r, n) => {
                        ! function() {
                            const e = () => {
                        ...
                        const a = a => {
                            try {
                                ...
                                ca().then(() => {
                                    const e = new Aa(n);
                                    e.environment.isTelegram && ue("loading", {
                                            value: 100
                                        }), n.hasAuth && e.getPlayer(), window.setTimeout(ke, 6e4), r(Ae(e, ["auth", "getFlags", "getLeaderboards", "getPayments", "getStorage", "serverTime"], "SDK")),
                                        function() {
                                            if (!new URLSearchParams(location.search).get("debug-mode")) return;
                                            const e = e => {
                                                    const {
                                                ...
                                                },
                                                {
                                                    ...
                                                    let t;
                                                    e || (() => {
                                                        if (document.head.querySelector(`#${ea}`)) return;
                        ...
                        window.loadEnvironmentPromise.then(e => {
                            ...
                            Ea("checkAndSendGameInfo tech data:", e), ka(() => {
                                l.F.postToParent((0, i.cp)(e))
                            })
                        }, 1e4)
                    }), Oa.then(() => Ea("Initialized")), Oa)
                })
            }
        }
        if (wa(Ca, "deviceInfo", new mr(Ta)), window.YaGames && window.YaGamesAdded) {
            const e = 'YaGames is already defined. Please, check double <script src="https://yandex.ru/games/sdk/v2"> on the page.';
            lr() && l.F.postToParent((0, i.qs)(new Error(e))), (0, y.T)(new Error(e))
        } else {
            try {
                Gt.setup()
            } catch (e) {
            ...
            window.top !== window && ca().then(function() {
                Object.values(i.N3).forEach(e => {
                    const t = e(),
                        [r] = t.action.split(c.ej);
                    document.addEventListener(r, () => l.F.postToParent(t), !0)
                })
            }), sa.overrideCacheSearch(), "SecurityPolicyViolationEvent" in window ? window.addEventListener("securitypolicyviolation", ({
                blockedURI: e,
                columnNumber: t,
                disposition: r,
                documentURI: n,
        ...
        }), window.YaGamesAdded = !0, window.YaGames = Ca;
        const Ia = Ca
    })(), YaGames = n.default
})();
